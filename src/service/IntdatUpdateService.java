...
public class IntdatUpdateService {
    ...
    public void updateInvData(InvIntData invIntData) throws Exception {
        StringBuffer sb = new StringBuffer("UPDATE inv_intdata t SET t.compan = '" + invIntData.getCompan()+"' , "+"t.mngnam = '"+ invIntData.getMngnam()+"' where t.custname = '" +invIntData.getCustName()+"' and t.txndate like '"+chgDate2(invIntData.getTxnDate())+"%'");//按月修改
