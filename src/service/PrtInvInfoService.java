...
public class PrtInvInfoService {
    ...
    public List<PrtInvInfo> getInvdatByInvNo(String invcode, String invno) throws Exception {
        String sqlStr = "SELECT t.invCode, t.invNo,t.custCode,t.custName, t.txnDate ,t.intAmt ,t.syAmt ,t.txnType ,t.currencyType ,t.iouNum,t.itemState, t.apndate,t.creamt, t.debamt ,t.contno ,t.invrat ,t.prtdat,t.enddat FROM inv_intdata t WHERE t.invcode = '" + invcode + "' AND t.invno = '" + invno +"' and t.itemstate = '2'";
    ...
    public List<PrtInvInfo> getInvdatByInvNo2(String invcode, String invno1,String invno2) throws Exception {
        String sqlStr = "SELECT t.invCode, t.invNo,t.custCode,t.custName, t.txnDate ,t.intAmt ,t.syAmt ,t.txnType ,t.currencyType ,t.iouNum,t.itemState, t.apndate,t.creamt, t.debamt ,t.contno ,t.invrat ,t.prtdat,t.enddat FROM inv_intdata t WHERE t.invcode = '" + invcode + "' AND t.invno between '" + invno1 + "'"+" and '"+invno2+"' and t.itemstate = '2'";
        return jdbcTemplate.query(sqlStr, new PrtInvInfoMapper());
    }
