...
public class PrtInvInfoService {
    ...
    public List<PrtInvInfo> getInvdatByInvNo(String invcode, String invno) throws Exception {
        String sqlStr = "SELECT t.invCode, t.invNo,t.custCode,t.custName, t.txnDate ,t.intAmt ,t.txnType ,t.currencyType ,t.iouNum,t.itemState, t.apndate,t.creamt, t.debamt ,t.contno ,t.invrat ,t.prtdat FROM inv_intdata t WHERE t.invcode = '" + invcode + "' AND t.invno = '" + invno +"' and t.itemstate = '2'";
